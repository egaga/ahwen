 ...
 */
class BTreePage(
        private var currentBlock: database.layer_0_file.Block,
    ...
    fun split(splitpos: Int, flag: Int): database.layer_0_file.Block {
    ...
    private fun appendNew(flag: Int): database.layer_0_file.Block =
