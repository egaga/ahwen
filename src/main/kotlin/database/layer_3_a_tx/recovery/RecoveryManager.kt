...
class RecoveryManager(
    ...
    private fun createUndoRecord(block: database.layer_0_file.Block, offset: Int, oldValue: SqlValue): LogRecord = when (oldValue) {
    ...
    private fun isTemporaryBlock(block: database.layer_0_file.Block): Boolean =
