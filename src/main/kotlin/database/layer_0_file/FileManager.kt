...
interface FileManager {
     ...
     */
    fun read(block: database.layer_0_file.Block, bb: ByteBuffer)

    /**
     * Writes a buffer to of bytes to given block, which must exist in the file.
     */
    fun write(block: database.layer_0_file.Block, bb: ByteBuffer)

    /**
     * Adds a new block to given file and returns identifier for it.
     * If the file does not exist, it will be created.
     */
    fun append(fileName: FileName, bb: ByteBuffer): database.layer_0_file.Block
